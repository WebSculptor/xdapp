    ...
    <div className="flex-1">
      ...
      <div className="-mt-16">
        <div className="flex items-end justify-between px-3">
          <div className="w-[133.5px] h-[133.5px] rounded-full border-background border-[4px] bg-secondary"></div>

          <div className="flex items-center gap-2">
            <Button variant="outline" className="rounded-full mb-5">
              Edit profile
            </Button>
            <Button className="rounded-full mb-5 font-bold">Follow</Button>
          </div>
        </div>

        <div className="flex flex-col px-4 mt-4 pb-4 border-b">
          <h1 className="text-xl font-bold">James Joan</h1>
          <p className="text-sm text-muted-foreground mt-1 flex items-center">
            <Copy className="w-3 h-3 mr-1.5" />
            0xC0E11e7674B3267175569e1c42b85bB5554aFEB4
          </p>
          <p className="text-base my-3 flex items-center leading-5">
